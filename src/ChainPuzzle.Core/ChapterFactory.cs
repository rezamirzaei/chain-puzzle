...
public static class ChapterFactory
{
    ...
    private static readonly ChapterBlueprint[] Blueprints =
    {
        ...
        new(
            ...
            new[] { 0, 0, 0, 5, 4, 2, 4, 5, 5, 3, 4, 5, 0, 5, 1, 5, 4, 3, 4 }),
        new(
            "chapter-07",
            "Chapter 7",
            "Pyramid",
            ...
            new[] { 1, 1, 0, 0, 5, 4, 4, 5, 0, 0, 0, 1, 1, 5, 4, 5, 1, 1, 5 }),
        new(
            "chapter-08",
            "Chapter 8",
            "Shield",
            ...
            new[] { 5, 5, 0, 1, 0, 5, 5, 5, 5, 4, 4, 0, 0, 5, 0, 2, 1, 5, 5 }),
        new(
            "chapter-09",
            "Chapter 9",
            "Citadel",
            ...
            new[] { 2, 2, 2, 1, 0, 5, 1, 3, 2, 1, 2, 0, 0, 2, 1, 0, 0, 4, 0 }),
        new(
            "chapter-10",
            "Chapter 10",
            "Harbor",
            ...
            new[] { 0, 0, 2, 1, 2, 3, 1, 1, 5, 0, 2, 2, 3, 3, 2, 1, 1, 2, 3 })
    };
